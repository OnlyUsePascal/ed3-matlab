...
phi = pi/2; % Initial orientation (90 degrees or pi/2 radians, facing right)
...
for t = 1:t_steps
    ...
    % The robot should always face the direction of travel, i.e., tangent of the path
    phi = pi / 2;  % Keep the robot facing to the right (90 degrees)
